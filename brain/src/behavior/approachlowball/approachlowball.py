...
'''"This behavior will search for the ball when in the looking down state."'''

class Approachlowball(basebehavior.abstractbehavior.AbstractBehavior):
    ...
    def get_name(self):
        return "Approachlowball"

    def check_postcondition(self):
        m = memory.Memory()
        return eval("m.is_now('approachlowball',['True'])")
