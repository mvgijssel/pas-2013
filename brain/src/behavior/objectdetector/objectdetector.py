...
'''"Behaviour always running in th background to supply the Nao with object locations like Ball / Goal / etc"'''

class ObjectDetector(basebehavior.abstractbehavior.AbstractBehavior):
