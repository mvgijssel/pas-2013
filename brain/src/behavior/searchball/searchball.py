...
'''"This behavior will search the ball until it has found a red blob that is big enough"'''

class Searchball(basebehavior.abstractbehavior.AbstractBehavior):
    ...
    def check_postcondition(self):
        m = memory.Memory()
        return eval("m.is_now('searchball',['True'])")
