    ...
    def getPos(self):
        ...
        for i in range(0,W):
            for j in range(0,H):
                ...
                factor = 0.7 # er moet minimaal "factor" keer zoveel "kleur" zijn als andere kleuren samen
                maxwaarde = 120 # de andere kleuren mogen maximaal deze waarde hebben, om wit uit te schakelen
                if (color == "red"):
