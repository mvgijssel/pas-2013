...
class RasterImage:
    ...
    def getPos(self):
        ...
        self.p_maxwaarde = 0.9 * float((random.randint(80,130))/float(100))
        self.p_minwaarde = 0.7 * float((random.randint(80,130))/float(100))
        self.p_factor = 0.5 * (float(random.randint(80,130))/float(100))
